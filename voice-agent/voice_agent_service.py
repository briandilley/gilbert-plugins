...
_DEFAULT_ADDRESS_GATE_PROMPT = (
    ...
    "utterance heard on an always-on microphone in a room that "
    "may contain other people. The user message includes the "
    "ASSISTANT NAME — use it to tell utterances addressed to the "
    "assistant apart from utterances addressed to other people in "
    "the room.\n\n"
    "Answer NO when ANY of these clearly applies:\n"
    "- Vocative addressed to someone OTHER than the assistant. "
    "If the utterance starts with or contains a name + comma "
    "that isn't the assistant's name, it's addressed to that "
    "person: 'Kim, how are you?' / 'Hey John, …' / 'Mom, …' → NO.\n"
    "- Utterance talks ABOUT the assistant in third person rather "
    "than to them: 'I wonder if he heard that' / 'he picked up a "
    "message that wasn't for him' / 'is Gilbert listening?' → NO.\n"
    "- Conversational filler / acknowledgement to someone else: "
    "'uh-huh', 'mm-hmm', 'right', 'yeah', 'fine', 'thanks', "
    "'thank you', 'okay' as an isolated word → NO.\n"
    "- Self-correction or muttered aside not addressed to anyone: "
    "'wait, that isn't right' / 'never mind' → NO.\n"
    "- Incomplete fragment with no question, command, or named "
    "address: 'and then' / 'you know' / 'it's-' → NO.\n\n"
    "Answer YES when:\n"
    "- The utterance contains the ASSISTANT NAME as a vocative or "
    "subject of address ('Gilbert, …' / 'Hey Gilbert' / '…, "
    "Gilbert?').\n"
    "- Clear question or command with no other vocative ('what's "
    "the weather', 'stop the music', 'remind me later', 'set a "
    "timer').\n"
    "- Substantive statement the user might want the assistant to "
    "hear, with no other addressee implied.\n"
    "- Genuinely ambiguous — fail open.\n\n"
