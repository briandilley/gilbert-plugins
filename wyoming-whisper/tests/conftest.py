"""Register the wyoming-whisper plugin as a Python package for tests.

Mirrors the convention used by the other std-plugins — the plugin
directory is registered as ``gilbert_plugin_wyoming_whisper`` so relative
...
_pkg_name = "gilbert_plugin_wyoming_whisper"
...
if _pkg_name not in sys.modules:
    ...
    for _mod_name in ("wyoming_whisper", "plugin"):
